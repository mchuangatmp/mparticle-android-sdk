...
```groovy
dependencies {
    implementation 'com.mparticle:android-core:5.17.1'
}
```
...
dependencies {
    implementation (
        'com.mparticle:android-example-kit:5.17.1',
        'com.mparticle:android-another-kit:5.17.1'
    )
}
```
...
[Iterable](https://github.com/mparticle-integrations/mparticle-android-integration-iterable)                 |  [`android-kahuna-kit`](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22com.mparticle%22%20AND%20a%3A%22android-kahuna-kit%22) -->
